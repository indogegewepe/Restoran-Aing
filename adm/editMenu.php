                            ...
                            <div class="p-5">
                                ...
                                <form action="" class="user" method="post">
                                    <div class="form-group">
                                        <input type="text" name="nama" class="form-control" placeholder="Nama menu" value="<?= $menuBefore["nama_menu"]; ?>" required>
                                    </div>
                                    <div class="form-group">
                                        <input type="number" name="harga" class="form-control" placeholder="Harga" value="<?= $menuBefore["harga"]; ?>" required>
                                    </div>
