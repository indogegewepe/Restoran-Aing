...
if(!isset($_SESSION['log'])){
    ...
    if($_SESSION["jenisPegawai"] == "Admin")
    {
        // sesuaikan
        header("Location: http://localhost/loginRegister/Halaman%20awal/adm/index.php");
    }else
    {
        // sesuaikan 
        header("Location: http://localhost/loginRegister/Halaman%20awal/kasir/index.php");
    }
}
...
<body class="bg-gradient-danger centerlogin">
